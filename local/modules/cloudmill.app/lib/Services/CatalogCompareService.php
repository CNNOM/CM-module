...
final class CatalogCompareService
{
    ...
    public function fillProductInfo(array &$items): void
    {
        ...
        $sections = [];
        if ($sectionIds) {
            $sectionList = IBlockHelper::getSectionList(
    ...
    public function normalizeCompareIds(array $ids): array
    {
        ...
        $offersIblockId = IBlockHelper::getID('offers');
        $catalogIblockId = IBlockHelper::getID('catalog');
        ...
        $existingOffers = IBlockHelper::getList(
