...
use Cloudmill\App\Validation\OrderValidator;
...
final class OrderService
{
    ...
    private static function setProperties(Order $order, OrderData $data): void
    {
    ...
    private static function setComment(Order $order, OrderData $data): void
    {
    ...
    private static function setDelivery(Order $order, OrderData $data): void
    {
    ...
    private static function sendOrderEmail(Order $order, OrderData $data): void
    {
        $email = $data->email();
