...
use Cloudmill\App\Services\UserListCookieStorage;

final class UserActionsHelper
{
    ...
    public static function getStorage(string $action): UserListCookieStorage
    {
        return new UserListCookieStorage(self::getCookieName($action));
    }
